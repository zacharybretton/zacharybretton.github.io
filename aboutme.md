...
<div class="home-refresh">
  <section class="zr-hero">
    ...
    <div class="zr-link-row">
      ...
      <a class="zr-btn zr-btn-secondary" href="https://github.com/zacharybretton">View GitHub</a>
      <a class="zr-btn zr-btn-secondary" href="/assets/pdf/Resume_ZB.pdf">Download Resume</a>
    </div>
  </section>
  ...
  <section class="zr-grid">
    ...
    <article class="zr-card">
      <h3>Training</h3>
      <p>Ph.D. in Cognitive and Computational Neuroscience, University of Texas at Austin.</p>
    </article>
  </section>
  ...
  <section class="zr-section" id="timeline">
    <h2>Timeline</h2>
    <div class="zr-timeline-panel">
      <div class="zr-timeline">
  ...
  <section class="zr-section" id="selected-work">
    <h2>Selected Work</h2>
    <div class="zr-project-grid">
      <article class="zr-project">
        <h3><a href="https://github.com/zacharybretton/CNN_XRay_classification">COVID-19 Chest X-Ray Classification</a></h3>
        <p>Built a TensorFlow CNN pipeline to classify chest X-rays into COVID-19, Normal, and Pneumonia classes, surpassing 81 percent accuracy.</p>
      </article>
      <article class="zr-project">
        <h3><a href="https://github.com/zacharybretton/modern_haxby2001">Modern Haxby Replication</a></h3>
        <p>Recreated the Haxby et al. analysis with modern ML methods (including XGBoost) to examine distributed object representations in fMRI data.</p>
      </article>
      <article class="zr-project">
        <h3><a href="https://doi.org/10.1162/jocn_a_02206">Journal of Cognitive Neuroscience (2024)</a></h3>
        <p>Suppression of maintained working-memory content alters long-term memory traces.</p>
      </article>
      <article class="zr-project">
        <h3><a href="https://doi.org/10.1109/BioCAS54905.2022.9948604">IEEE BioCAS (2022)</a></h3>
        <p>Estimated intrinsic manifold dimensionality to classify task-related information in human and non-human primate data.</p>
      </article>
    </div>
  </section>

  <section class="zr-section zr-section-last">
    <h2>Beyond Work</h2>
    <p>
      Brooklyn born, Austin shaped. When I am not working, I am usually watching the
      <strong>Brooklyn Nets</strong>, spending time with my wife <strong>Dr. Shelby Bretton</strong>,
      and hanging out with our dog <strong>Tycho</strong>.
    </p>
  </section>
</div>
